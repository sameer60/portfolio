  ...
  return (
    <header className="body-font">
      ...
      >
        ...
        <nav className="md:ml-auto flex gap-4 items-center text-base justify-center">
          <Link
            href="/uses"
            className="mr-5 font-semibold text-lg cursor-pointer group transition duration-300"
          >
            /uses
